#source https://raw.githubusercontent.com/wepe/MachineLearning/master/SVM/SVM_by_QP/SVCQP.py
#这个直接使用凸优化的拉格朗日乘子法解原始解得到,不想安装这么多模板，这边就不多弄了，测试文件也在上面的链接里面，这个应该是简单的
import numpy as np
